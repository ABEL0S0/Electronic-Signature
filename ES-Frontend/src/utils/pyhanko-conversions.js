 ...
 */
export const convertToBackendPage = (page) => page - 1;
/**
 ...
 */
export const convertToFrontendPage = (page) => page + 1;
/**
 ...
 */
export const convertCanvasToPDFCoordinates = (canvasX, canvasY, canvasWidth, canvasHeight, pageWidth, pageHeight) => {
 ...
 */
export const calculateSignatureBox = (centerX, centerY, signatureWidth = 120, signatureHeight = 60) => {
 ...
 */
export const formatCoordinates = (posX, posY) => {
    return `(${posX}, ${posY})`;
};
/**
 ...
 */
export const getConversionInfo = (page, posX, posY) => {
 ...
 */
export const validatePyHankoCoordinates = (page, posX, posY) => {
